...
class Job(Base):
    ...
    queue_name: Mapped[str] = mapped_column(String(255), nullable=False, default="default", index=True)
    ...
    workflow_step_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True, index=True)
...
class Worker(Base):
    ...
    queues: Mapped[list] = mapped_column(JSON, nullable=False, default=lambda: ["default"])
    capabilities: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    max_concurrency: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    last_heartbeat_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    status: Mapped[WorkerStatus] = mapped_column(
        Enum(WorkerStatus, name="worker_status"), nullable=False, default=WorkerStatus.ONLINE
    )
...
class RecurringJob(Base):
    ...
    payload: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
    queue_name: Mapped[str] = mapped_column(String(255), nullable=False, default="default")
...
class WorkflowRun(Base):
    ...
    status: Mapped[WorkflowStatus] = mapped_column(
        Enum(WorkflowStatus, name="workflow_status"), nullable=False, default=WorkflowStatus.PENDING
    )
